...
CREATE TABLE IF NOT EXISTS `dbventaslaravel`.`detalle_ingreso` (
  ...
  INDEX `kf_detalle_ingreso_idx` (`idingreso` ASC) VISIBLE,
  INDEX `fk_detalle_ingreso_articulo_idx` (`idarticulo` ASC) VISIBLE,
  CONSTRAINT `kf_detalle_ingreso`
...
CREATE TABLE IF NOT EXISTS `dbventaslaravel`.`venta` (
  ...
  `estado` VARCHAR(20) NOT NULL,
  PRIMARY KEY (`idventa`),
  INDEX `fk_venta_clente_idx` (`idcliente` ASC) VISIBLE,
  CONSTRAINT `fk_venta_clente`
